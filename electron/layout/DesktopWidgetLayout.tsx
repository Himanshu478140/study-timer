...
import type { WallpaperConfig } from '../../src/components/wallpaper/WallpaperSelector';
import { WALLPAPERS, WallpaperGrid } from '../../src/components/wallpaper/WallpaperSelector';
import { YouTubeWallpaper } from '../../src/components/wallpaper/YouTubeWallpaper';
import { VideoWallpaper } from '../../src/components/wallpaper/VideoWallpaper';
import { ParticleWallpaper } from '../../src/components/wallpaper/ParticleWallpaper';
import '../../src/components/wallpaper/animatedGradients.css';
        ...
        <div style={{
            ...
            {showSettings && (
                <div style={{
                    ...
                    <WallpaperGrid currentId={wallpaper.id} onSelect={(wp: WallpaperConfig) => {
                        setWallpaper(wp);
