...
import { AttendanceSetupWizard, AttendanceRings, useAttendance, FocusCalendar } from './attendance';
...
export const CalendarSelectorPanel = ({ isOpen, onClose, triggerRef }: CalendarSelectorPanelProps) => {
    ...
    const { isWizardOpen, setIsWizardOpen } = useAttendance();
    ...
    useEffect(() => {
        ...
        const handleClickOutside = (e: MouseEvent) => {
            ...
            const isModalClick = target.closest('.add-event-modal-container') ||
                target.closest('.quick-status-popover') ||
                target.closest('.attendance-setup-wizard');
        ...
        <>
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        {/* 2-Column Calendar & Attendance View */}
